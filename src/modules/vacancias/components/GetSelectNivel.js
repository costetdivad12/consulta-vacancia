...
const GetSelectNivel = () => {
    ...
    const handleSelectChage = (e) => {
        ...
        const municipios = `/ubication/ct/level/${id_muni}`;

        api.get(municipios).then((resp) => {
            //   console.log(resp.data);
    ...
    const handleSelectChageMuni = (e) => {
        ...
        const datoss = `/vacancy/type/${chageSelectTipo}/level/${chageSelect}/ubication/${id_mu}`;
        api.get(datoss).then((resp) => {
